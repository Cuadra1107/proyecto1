...
//alert("Navbar");
    $('#navbar_x').append('<nav class="navbar navbar-expand-lg navbar-light bg-light"><a class= "navbar-brand" href = "index.html" style="color:white"> <img src="src/images/logohome.png" width="50px"> E y R</a ><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button><div class="collapse navbar-collapse" id="navbarNav"><ul class="navbar-nav ml-auto"><li class="nav-item"><a class="nav-link" href="index.html"><i class="fas fa-home"></i>Home<span class="sr-only"></span></a></li><li class="nav-item"><a class="nav-link" href="noticias.html"><i class="fas fa-newspaper"></i>Noticias</a></li><li class="nav-item"><a class="nav-link" href="libros.html"><i class="fas fa-book"></i>Libros</a></li><li class="nav-item"><a class="nav-link" href="acerca.html"><i class="fas fa-question-circle"></i>Acerca de</a></li></ul></div></nav >');
    $('#footer').append('<div class="row"><div class="col text-center foo_link"><center><img src="src/images/ubicacion.png" width="30px" alt=""></center><a href="acerca.html" target="_blank" rel="noopener noreferrer">Ubicación</a></div><div class="col text-center foo_link"><center><img src="src/images/correo.png" width="30px" alt=""></center><a href="acerca.html" target="_blank" rel="noopener noreferrer">Correo</a></div><div class="col text-center foo_link"><center><img src="src/images/telefono.png" width="30px" alt=""></center><a href="acerca.html" target="_blank" rel="noopener noreferrer">Telefono</a></div></div>');
